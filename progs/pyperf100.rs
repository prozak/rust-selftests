...
// Direct translation of tools/testing/selftests/bpf/progs/pyperf100.c
// (STACK_MAX_LEN=100, #include "pyperf.h" with none of SUBPROGS/GLOBAL_FUNC/
// USE_BPF_LOOP/USE_ITER/NO_UNROLL/UNROLL_COUNT defined -> the plain
// __always_inline __on_event() with a full-unroll-pragma'd for loop).
//
