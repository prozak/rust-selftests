...
// tools/testing/selftests/bpf/progs/test_sysctl_prog.c, bpf-rs-core idiom.
...
#[no_mangle]
static tcp_mem_name: [u8; TCP_MEM_NAME_LEN] = *b"net/ipv4/tcp_mem\0";
