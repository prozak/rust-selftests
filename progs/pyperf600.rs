...
// Direct translation of tools/testing/selftests/bpf/progs/pyperf600.c
// (STACK_MAX_LEN=600, #include "pyperf.h" with none of SUBPROGS/GLOBAL_FUNC/
// USE_BPF_LOOP/USE_ITER/NO_UNROLL defined -> the plain __always_inline
// __on_event() with a for loop; UNROLL_COUNT=150 is just a clang unroll-count
// pragma hint with no behavioral effect, so it doesn't need a Rust
// equivalent -- same shape as pyperf100.rs, just STACK_MAX_LEN=600).
//
