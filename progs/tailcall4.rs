...
// Direct translation of tools/testing/selftests/bpf/progs/tailcall4.c,
// bpf-rs-core idiom.
//
...
// generic (matches tailcall_cgrp_storage_no_storage.rs idiom).
...
extern "C" fn entry(skb: *const __sk_buff) -> i32 {
    let key = unsafe { selector };
    bpf_tail_call(skb as *const core::ffi::c_void, &jmp_table, key as u32);
    3
}
